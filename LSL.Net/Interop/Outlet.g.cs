...
internal static unsafe partial class LSL
{
    ...
    [UnmanagedCallConv(CallConvs = new Type[] { typeof(System.Runtime.CompilerServices.CallConvCdecl) })]
    [return: NativeTypeName("lsl_outlet")]
    public static partial IntPtr lsl_create_outlet_ex([NativeTypeName("lsl_streaminfo")] IntPtr info, [NativeTypeName("int32_t")] int chunk_size, [NativeTypeName("int32_t")] int max_buffered, [NativeTypeName("lsl_transport_options_t")] int flags);
